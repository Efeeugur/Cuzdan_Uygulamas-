...
public interface ITransactionService
{
    ...
    Task<IEnumerable<TransactionDto>> GetFilteredTransactionsAsync(string userId, TransactionFilterDto filter);
    ...
    Task<TransactionSummaryDto> GetTransactionSummaryAsync(string userId, TransactionFilterDto filter);
